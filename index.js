const contentLetterSrart_actived = "Hello em gái snvv nhaaa. a lời chúc nho nhỏ cho Linh." //Lời mở đầu cho bức thư
const mainContentLetter = "Chúc Linh sinh nhật vui vẻ, tràn đầy hạnh phúc bên gia đình và người thân, luôn vui vẻ và thành công trong công việc và cuộc sống. Tuổi mới sinh đẹp hơn, học giỏi hơn, mỏ bót hỗn với a lại. Happy Birthday Thảo Linh (Mỏ hỗn!!!). " //Nội dung của bức thư

// Gắn 1 đường link ảnh bất kì
let imgStart = document.querySelector(".myAI"); //Hình ảnh xuất hiện trong lời mở đầu của bức thư
imgStart.src = "./img/Screenshot 2024-01-06 122156.png";

// Gắn 1 link ảnh bất kì
let imgLetter = document.querySelector(".img");
imgLetter.src = "./img/387332354_1104240477602814_1206454217868122494_n.png"; //Hình ảnh xuất hiện trong nội dung của bức thư sau khi bức thư được viết ra hết
